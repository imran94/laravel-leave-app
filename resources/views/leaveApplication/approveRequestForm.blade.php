            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" data-original-title="">
                        <h2><i class="glyphicon glyphicon-list"></i> Approve Request Form</h2>
                    </div>
                    <div class="box-content">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @endif
                                <form class="form-horizontal" role="form" action="approve" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <button class="btn btn-primary float-left m-1" id="btnSubmit"
                                                    name="btnSubmit" value="1">Approve</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
