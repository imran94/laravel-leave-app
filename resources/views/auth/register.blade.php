                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="branch" name="branch" class="form-control" onchange="onSelectBranch(this)"
                                        required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="department" name="department" class="form-control"
                                        onchange="onSelectDepartment(this)" disabled required>
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="designation" id="designation" class="form-control" disabled required>
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="teamLead" class="col-md-4 control-label">Team Lead/Head of Department</label>
                                <div class="col-md-6">
                                    <select name="teamLead" class="form-control">
                                        <option value="0">Select Team Lead/Head of Department</option>
